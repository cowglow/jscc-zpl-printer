...
// import {generateZPL} from './generate-jscc-zpl.ts';
...
//     document.querySelector<HTMLSelectElement>('#printer-name');
...
// const sendToPrinterButton = document.querySelector<HTMLButtonElement>(
// 'button#send-to-printer',
// );
// const sendToTerminalButton = document.querySelector<HTMLButtonElement>(
// 'button#send-to-terminal',
// );
// const verifyConnectionButton = document.querySelector<HTMLButtonElement>(
// 'button#verify-connection',
// );
// const resetButton = document.querySelector<HTMLButtonElement>("button#reset")
// JSCC Modifications
// const participantName =
//     document.querySelector<HTMLInputElement>('#participant-name');
